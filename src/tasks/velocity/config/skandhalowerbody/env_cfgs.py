"""SkandhaLowerBody velocity environment configurations."""

from src.assets.robots import (
  SKANDHA_LOWER_BODY_ACTION_SCALE,
  get_skandha_lower_body_cfg,
)
...
def skandha_lower_body_rough_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create SkandhaLowerBody rough terrain velocity configuration."""
  ...
  cfg.scene.entities = {"robot": get_skandha_lower_body_cfg()}

  # Set raycast sensor frame to SkandhaLowerBody's floating base.
  ...
  joint_pos_action.scale = SKANDHA_LOWER_BODY_ACTION_SCALE
...
def skandha_lower_body_flat_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create SkandhaLowerBody flat terrain velocity configuration."""
  cfg = skandha_lower_body_rough_env_cfg(play=play)
